...
int train_tmva()
{
    ...
    loadTree(loader, "Background", 25.0, "condor/output-files/TT/make_training_trees_TT.root"  , "mvatraintt");
    loadTree(loader, "Background", 50.0, "condor/output-files/QCD/make_training_trees_QCD.root", "mvatraintt");
