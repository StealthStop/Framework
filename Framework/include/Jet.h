...
private:
    ...
    void jet(NTupleReader& tr)
    {
        ...
        auto* jets_pt30_ = new std::vector<TLorentzVector>();
        auto* jets_pt40_ = new std::vector<TLorentzVector>();
        auto* jets_pt45_ = new std::vector<TLorentzVector>();
        ...
        auto* goodjets_       = new std::vector<TLorentzVector>(Jets);
        auto* goodjets_pt30_  = new std::vector<TLorentzVector>();
        auto* goodjets_pt40_  = new std::vector<TLorentzVector>();
        auto* goodjets_pt45_  = new std::vector<TLorentzVector>();
        auto* goodjets_csv_   = new std::vector<double>(Jets_CSV);
