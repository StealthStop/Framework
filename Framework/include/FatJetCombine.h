...
//            std::cout << GoodJetsAK8.at(j) << " " << JetsAK8.at(j).Eta() << " " << JetsAK8.at(j).Pt() << std::endl;
        }
        ...
        bool likelyB1 = false, likelyB2 = false;
        ...
        if(NGoodLeptons == 2 && NGoodJetsAK8 == 2)
        {
//            std::cout << "-----------------" << std::endl;
            ...
            for(unsigned int j=0; j < JetsAK8.size(); j++)
            {
                if(GoodJetsAK8.at(j))
                {
                    ...
                    for(unsigned int s=0; s < subjets.at(j).size(); s++)
                    {
                        ...
                        if (sj.DeltaR(Bottom1) < 0.2 && abs( 1 - sj.Pt()/Bottom1.Pt()) < 0.2 && subjets_CSV.at(j).at(s) > 0) 
                        {
                            likelyB1= true;
                            nBottom1Ovl += 1;
                            BOvlDeltaR.push_back(sj.DeltaR(Bottom1));
                            BOvlPt.push_back( sj.Pt()/Bottom1.Pt() );
                            BOvlDCSV.push_back(subjets_CSV.at(j).at(s));
                        }
                        if (sj.DeltaR(Bottom2) < 0.2 && abs( 1 - sj.Pt()/Bottom2.Pt()) < 0.2 && subjets_CSV.at(j).at(s) > 0)
                        {
                            likelyB2= true;
                            nBottom2Ovl += 1;
                            BOvlDeltaR.push_back(sj.DeltaR(Bottom2));
                            BOvlPt.push_back( sj.Pt() / Bottom2.Pt());
                            BOvlDCSV.push_back(subjets_CSV.at(j).at(s));
                        }                                                 
                    }
                }
            }
//            std::cout << "B1: " << likelyB1 << " B2: " << likelyB2 << std::endl;
        ...
        tr.registerDerivedVar("BOvl_B1Filter"+myVarSuffix_, likelyB1);
        tr.registerDerivedVar("BOvl_B2Filter"+myVarSuffix_, likelyB2);
